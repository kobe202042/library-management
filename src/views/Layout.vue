...
<div>
  <!--头部区域 -->
  <div style="height: 60px;line-height: 60px;background-color: aliceblue;margin-bottom: 2px;display: flex">
  ...
  <div style="display: flex">
    <!--侧边栏-->
    <div style="width: 200px;min-height:calc(100vh - 60px);height:200px;overflow: hidden;margin-right: 2px;background-color: white">
